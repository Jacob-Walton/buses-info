...
const { verifyEntryPoints, printValidationSummary } = require('./utils/file-utils');

console.log('Bus Info Path Checker');
console.log('====================');
console.log(`Current environment: ${config.isProd ? 'PRODUCTION' : 'DEVELOPMENT'}`);
console.log(`Source directory: ${config.sourceDir}`);
console.log(`Output directory: ${config.isProd ? config.outputDir : 'Development mode - using wwwroot'}`);
